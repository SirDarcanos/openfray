...
The book reduced to cards. The first three sit behind the screen and compress the rules
a fight or an evening actually calls for, each pointing back at the chapter that owns it.
The five after them face the other way: boards and lists written as a customer would see
them, ready to be handed across the table when the party walks in and asks what there is.
...
Five boards, each written as its house would write it, priced as the chapters price
them. Which house hands over which board follows the sixth chapter's ladder.
...
Under it, in a harder hand: _No tick. No exceptions. Yes, you._
