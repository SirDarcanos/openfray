...
OpenFray's SRD 5.1 compendium (via [dnd5eapi.co](https://www.dnd5eapi.co)) is used
...
- **Creatures and mechanics.** The stat blocks and game mechanics — every field of a
  ...
  Attribution 4.0 International License (CC BY 4.0). You are free to share and adapt this
  material, including commercially, provided you give appropriate credit to OpenFray
  (<https://openfray.app>), provide a link to the licence, and indicate if changes were
  made.
- **Lore, art, and prose.** All descriptive and narrative text — including each creature's
  `description` and the chapter text of each work — together with any artwork, is © 2026
  OpenFray, all rights reserved. It is published to be read, and is not licensed for reuse
  in other products.
...
used under the **Open Game License v1.0a**. ToB 3 designates its monster names,
descriptions, statistics, and abilities as Open Game Content; we include **only** that.
We do **not** include any Product Identity — artwork, sidebars, "fiction"/story text,
or the entries the book reserves as PI (the Archangels, the Animal Lord, the Arch-Devil,
the Fey Ladies/Lord, and the Fiend Lords), all of which are excluded. **Changes were
made**: the stat blocks were reformatted and restructured into OpenFray's schema.
...
Southlands ©2021 Open Design LLC. Authors: Richard Green with Wolfgang Baur, Basheer
Ghouse, Kelly Pawlik.

The Scarlet Citadel © 2021 Open Design LLC. Authors: Steve Winter, Wolfgang Baur, Scott
Gable, and Victoria Jaczko.

Tome of Beasts © 2016 Open Design LLC; Authors: Chris Harris, Dan Dillon, Rodrigo Garcia
Carmona, and Wolfgang Baur.

Tome of Beasts 2 © 2020 Open Design LLC; Authors Wolfgang Baur, Celeste Conowitch, Darrin
Drader, James Introcaso, Philip Larwood, Jeff Lee, Kelly Pawlik, Brian Suskind, Mike
Welham.
