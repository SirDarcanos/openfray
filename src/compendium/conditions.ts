 ...
 * action prose and the initiative tracker's condition badges. Verbatim effect text
 * from the official SRD 5.2.1 (2024) under CC-BY-4.0 — the boilerplate "While you
 * have the X condition…" lead-in is omitted (the card is titled with the name).
 * WotC attribution lives in the in-app Credits and `CREDITS.md`. Display-only; no
 * mechanics are derived from it (the dice engine reads `combat/conditionrules.ts`).
 */
