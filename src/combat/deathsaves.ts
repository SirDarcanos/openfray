...
export type DeathSaveOutcome = 'success' | 'failure' | 'critical-success' | 'critical-failure'
 ...
 */
export function rollDeathSave(pc: PlayerCharacter, ctx: RollContext = {}): DeathSaveRoll {
