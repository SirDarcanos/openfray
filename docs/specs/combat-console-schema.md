...
A library Creature is a _template_; when added to combat it's instantiated into
...
```jsonc
{
  ...
  "groups": [
    {
      "usage": { "type": "atWill" },
      "spells": [{ "name": "Mage Hand", "ref": "srd-5.2:mage-hand" }],
    },
    {
...
## 2. Combatant (a creature _in_ an encounter)
...
The whole object is what gets pushed to player screens — _after_ the visibility
